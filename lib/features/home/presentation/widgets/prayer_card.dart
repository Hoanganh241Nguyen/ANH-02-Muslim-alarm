            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  _buildReminderButton(context, prayer.soundStatus, isCurrent),
                ],
              ),
            ),
          ],
  ...
  Widget _buildReminderButton(
    ...
    switch (status) {
      ...
      case SoundStatus.vibrate:
        ...
        backgroundColor = AppColors.streakBg.withValues(alpha: 0.72);
      ...
      case SoundStatus.silent:
        ...
        borderColor = AppColors.secondaryText.withValues(alpha: 0.16);
        break;
    }

    return Tooltip(
      message: 'Tap to change reminder mode',
      child: Material(
        ...
        child: InkWell(
          ...
          child: AnimatedContainer(
            ...
            child: Row(
              ...
              children: [
                Icon(iconData, color: color, size: 17),
              ],
            ),
          ),
        ),
